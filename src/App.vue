<template>
  <v-app class="overflow-hidden">
    ...
    <v-main>
      ...
      <!--No device-->
      <template v-else-if="devices.length == 0 && functionChosen != 5">        <v-tooltip bottom>
...
export default {
  ...
  data: function () {
    return {
      ...
      appFunctions: [
        { text: "安装管理", icon: "apps" },
        { text: "档案管理", icon: "insert_drive_file" },
        { text: "Fastboot", icon: "mdi-android-debug-bridge", },
		{ text: "更多功能", icon: "more_horiz" },
      ],
      adbInstalled: true,
